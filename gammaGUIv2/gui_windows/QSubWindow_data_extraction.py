...
# Form implementation generated from reading ui file 'D:\gammaGUIv2\gammaGUIv2\Qt_Export\QSubWindow_data_extraction.ui'
#
...
class Ui_QSubWindow_data_extraction(object):
    """
    This is the Class of the Data Extraction Window. It contains the setupUI, retranslateUi, create_Ui_QSubWindow_data_extraction Methods
    From the Main Window the create_Ui_QSubWindow_data_extraction Method is called to open the Window, within this call
    setupUI, retranslateUi are called to initialize the Window.
    """
    def setupUi(self, QSubWindow_data_extraction):
        """
        This is the Method to setup the Window.
        Here are the changes made, to add functionality to the Window. Examples are given in gammaGUIv2/gui_windows/QSubWindow_set_your_working_directory.py
        -----
        ...
        #  Write Function to Bring it to work Count files / 100 .... see google
    ...
    def retranslateUi(self, QSubWindow_data_extraction):
        """
        This is the Mehode to "retranslate" the Names in the Window.
        If you want to make Changes to the displayed Names, make it HERE
        :param QSubWindow_data_extraction:
        :return:
        """
    ...
    def create_Ui_QSubWindow_data_extraction(self):
        """
        This is the Method to Open the Window from the MainWindow. This has to called from there.
        :return:
        """
