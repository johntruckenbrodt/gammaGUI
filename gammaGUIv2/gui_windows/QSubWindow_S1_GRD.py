...
# Form implementation generated from reading ui file 'D:\gammaGUIv2\gammaGUIv2\Qt_Export\QSubWindow_S1_GRD.ui'
#
# Created by: PyQt5 UI code generator 5.11.3
#
# WARNING! All changes made in this file will be lost!
#Author: Core Code Stefan Werner, implemenation Felix Behrendt
...
class Ui_QSubWindow_S1_GRD(object):
    ...
    def setupUi(self, QSubWindow_S1_GRD):
        ...
        QSubWindow_S1_GRD.setObjectName("QSubWindow_S1_GRD")
        QSubWindow_S1_GRD.resize(774, 255)

        self.verticalLayout = QtWidgets.QVBoxLayout(QSubWindow_S1_GRD)
        self.verticalLayout.setObjectName("verticalLayout")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout()
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.horizontalWidget_8 = QtWidgets.QWidget(QSubWindow_S1_GRD)
        ...
        self.verticalWidget_5 = QtWidgets.QWidget(QSubWindow_S1_GRD)
        ...
        self.horizontalWidget_14 = QtWidgets.QWidget(QSubWindow_S1_GRD)
        ...
        self.retranslateUi(QSubWindow_S1_GRD)
        QtCore.QMetaObject.connectSlotsByName(QSubWindow_S1_GRD)

    def retranslateUi(self, QSubWindow_S1_GRD):
        _translate = QtCore.QCoreApplication.translate
        QSubWindow_S1_GRD.setWindowTitle(_translate("QSubWindow_S1_GRD", "Dialog"))
        self.checkBox_3.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Selects all Files in the Import Folder</p></body></html>"))
        self.checkBox_3.setText(_translate("QSubWindow_S1_GRD", "Select all Files"))
        self.radioButton_6.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Select *.rar Data</p></body></html>"))
        self.radioButton_6.setText(_translate("QSubWindow_S1_GRD", "deramp (S1 SLC onyl)"))
        self.radioButton_5.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Select *.zip Data</p></body></html>"))
        self.radioButton_5.setText(_translate("QSubWindow_S1_GRD", "mosaicing (S1 SLC only)"))
        self.checkBox_4.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Check to Select Start and End Date of File Import</p></body></html>"))
        self.checkBox_4.setText(_translate("QSubWindow_S1_GRD", "Select Files (Period of time)"))
        self.dateEdit_3.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Select Start Date</p></body></html>"))
        self.label_5.setText(_translate("QSubWindow_S1_GRD", "Start Date"))
        self.dateEdit_4.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Select End Date</p></body></html>"))
        self.label_6.setText(_translate("QSubWindow_S1_GRD", "End Date"))
        self.pushButton_3.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Browse to Import Folder</p></body></html>"))
        self.pushButton_3.setText(_translate("QSubWindow_S1_GRD", "Browse"))
        self.pushButton_4.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Browse to Output Folder</p></body></html>"))
        self.pushButton_4.setText(_translate("QSubWindow_S1_GRD", "Browse"))
        self.buttonBox_2.setToolTip(_translate("QSubWindow_S1_GRD", "<html><head/><body><p>Press Ok to Start Extraction</p><p>Press Cancel to Quit Dialog</p></body></html>"))

    def create_Ui_QSubWindow_S1_GRD(self):
        QSubWindow_S1_GRD = QtWidgets.QDialog()
        ui = Ui_QSubWindow_S1_GRD()
        ui.setupUi(QSubWindow_S1_GRD)
        QSubWindow_S1_GRD.exec_()
